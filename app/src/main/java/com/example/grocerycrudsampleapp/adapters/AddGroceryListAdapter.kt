...
import com.example.grocerycrudsampleapp.databinding.AddGroceryListListItemBinding
...
class AddGroceryListAdapter(context: AppCompatActivity, private val clickListener: (GroceryList) -> Unit) :
    RecyclerView.Adapter<AddGroceryListAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        val binding: AddGroceryListListItemBinding = DataBindingUtil.inflate(layoutInflater,
            R.layout.add_grocery_list_list_item, parent, false)
    ...
    inner class MyViewHolder(val binding: AddGroceryListListItemBinding) : RecyclerView.ViewHolder(binding.root), OnCompletedGroceryUpdateListner {
